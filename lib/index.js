...
AppC.setProductionEU = function setProductionEU() {
	AppC.baseurl = DEFAULTS.PRODUCTIONEU.baseurl;
	AppC.registryurl = DEFAULTS.PRODUCTIONEU.registryurl;
	AppC.securityurl = DEFAULTS.PRODUCTIONEU.securityurl;
	AppC.pubsuburl = DEFAULTS.PRODUCTIONEU.pubsuburl;
	AppC.webeventurl = DEFAULTS.PRODUCTIONEU.webeventurl;
	AppC.cacheurl = DEFAULTS.PRODUCTIONEU.cacheurl;
	AppC.isProduction = DEFAULTS.PRODUCTIONEU.isProduction;
	AppC.supportUntrusted = DEFAULTS.PRODUCTIONEU.supportUntrusted;
	AppC.secureCookies = DEFAULTS.PRODUCTIONEU.secureCookies;
...
function isRunningInRegion() {
	return process.env.NODE_ENV === 'productioneu' ||
		process.env.APPC_ENV === 'productioneu';
}
