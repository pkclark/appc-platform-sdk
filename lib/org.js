...
module.exports = {
	 ...
	 */
	find: function (session, callback) {
	 ...
	 * @return {Function} - callback function
	 */
	getById: function (session, id, callback) {
		try {
	 ...
	 * @param  {Function} callback - callback
	 */
	findById: function (session, id, callback) {
		if (!id) {
			return callback(new Error('id is not valid'));
		}
	 ...
	 * @return {Function} - callback function
	 */
	getByName: function (session, name, callback) {
		try {
	 ...
	 * @return {Function} - callback function
	 */
	getCurrent: function (session, callback) {
