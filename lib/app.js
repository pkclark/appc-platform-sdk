...
module.exports = {
	 ...
	 */
	findAll: function (session, orgId, callback) {
	 ...
	 * @param {Function} callback
	 */
	find: function (session, appId, callback) {
	 ...
	 * @param {Function} callback
	 */
	update: function (session, app, callback) {
	 ...
	 * @param {Function} callback
	 */
	create: function (session, tiappxml, orgId, callback) {
		var self = this;
		...
		fs.readFile(tiappxml, function (err, data) {
			...
			self.updateTiApp(session, orgId, data, callback);
		});
	},

	crittercismID: function (session, guid, callback) {
		AppC.createRequest(session, '/api/v1/app/' + guid + '/crittercism_id', callback);
	},

	updateTiApp: function (session, orgId, tiappxml, callback) {
	 ...
	 * INTERNAL ONLY
	 */
	findPackage: function (session, guid, token, callback) {
	 ...
	 */
	findTeamMembers: function (session, guid, callback) {
	 ...
	 * @param {Function} callback
	 */
	delete: function (session, appId, callback) {
