 ...
 */
App.findAll = function (session, orgId, callback) {
 ...
 * @param {Function} callback
 */
App.find = function (session, appId, callback) {
 ...
 * @param {Function} callback
 */
App.create = function (session, tiappxml, orgId, callback) {
	var self = this;
...
App.crittercismID = function (session, guid, callback) {
