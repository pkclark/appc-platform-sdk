...
module.exports = {
	 ...
	 */
	createSessionFromRequest: function (req, callback) {
		if (!req.cookies) {
	 ...
	 */
	createSessionFromID: function (id, callback) {
	 ...
	 */
	requestLoginCode: function (session, sms, callback) {
		var self = this;
		AppC.User.find(session, function (err, user) {
			if (err) {
				return callback(err);
	 ...
	 */
	validateSession: function (object, callback) {
	 ...
	 */
	verifyLoginCode: function (session, code, callback) {
		var self = this,
