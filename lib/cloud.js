 ...
 */
Cloud.createNamedApp = function (session, name, callback) {
	var self = this;
	try {
		var tasks = [],
			apps;
 ...
 * @param {Function} callback
 */
Cloud.createApp = function (session, appName, orgId, appGuid, callback) {
 ...
 * @param {Function} callback
 */
Cloud.createUser = function (session, guid, keyvalues, callback) {
 ...
 * @param {Function} callback
 */
Cloud.retrieveUsers = function (session, guid, callback) {
